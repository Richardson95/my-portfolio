...
function App() {
  ...
  // Fallback icon shown on project cards that have no image
  const getProjectIconPath = (title: string): string => {
    if (title.includes('Chat')) return 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z'
    if (title.includes('Movie')) return 'M7 4v16M17 4v16M3 8h4m10 0h4M3 12h18M3 16h4m10 0h4M4 20h16a1 1 0 001-1V5a1 1 0 00-1-1H4a1 1 0 00-1 1v14a1 1 0 001 1z'
    if (title.includes('Wristwatch')) return 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z'
    if (title.includes('Wardrobe')) return 'M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z'
    if (title.includes('Wazobia')) return 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'
    if (title.includes('Dezirely')) return 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z'
  ...
  const projects: Project[] = [
    {
      title: 'BRG Prime',
      description: 'Nigerian property rental and roommate matching platform with verified listings, viewing bookings, subscription plans, community forum, and real-time notifications powered by Socket.IO.',
      image: '/brg-prime.png',
      link: 'https://brgprime.com/',
      tags: ['Vue.js', 'Pinia', 'Socket.IO', 'PropTech'],
      type: 'web'
    },
    {
      title: 'BRG Prime Mobile',
      description: 'Cross-platform companion app for the BRG Prime rental marketplace, offering property discovery, roommate matching, saved listings, and dashboard analytics with offline-first local storage.',
      image: '/brg-prime.png',
      link: 'https://brgprime.com/',
      tags: ['Flutter', 'Dart', 'Mobile', 'PropTech'],
      type: 'mobile'
    },
    {
      title: 'Formation Exceptionelle',
      description: 'Career development platform combining a full learning management system with a job board. Features course authoring and checkout, instructor onboarding, student and admin dashboards, and analytics reporting.',
      image: '/formation-exceptionelle.png',
      link: 'https://formationexceptionelle.com/',
      tags: ['Vue.js', 'Pinia', 'Tailwind CSS', 'EdTech'],
      type: 'web'
    },
    {
      title: 'Kudi9ja Pro',
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-slate-50 relative overflow-hidden">
      ...
      {/* About Section */}
      <section id="about" className="py-16 px-4 sm:px-6 lg:px-8 bg-white relative z-10">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-12 text-center animate-fadeIn">
      ...
      <section id="skills" className="py-16 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-2 shine-effect animate-fadeIn delay-100">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-2 shine-effect animate-fadeIn delay-200">
              <div className="flex items-center gap-3 mb-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-2 shine-effect animate-fadeIn delay-300">
              <div className="flex items-center gap-3 mb-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-2 shine-effect animate-fadeIn delay-400">
              <div className="flex items-center gap-3 mb-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-2 shine-effect md:col-span-2 animate-fadeIn delay-500">
              <div className="flex items-center gap-3 mb-6">
      ...
      {/* Experience Section */}
      <section id="experience" className="py-16 px-4 sm:px-6 lg:px-8 bg-white relative z-10">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-12 text-center animate-fadeIn">
                ...
                <div className={`h-48 overflow-hidden relative ${
                  ...
                  {project.image ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <svg
                        className="w-20 h-20 text-white/30 group-hover:scale-110 transition-transform"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth={1.5}
                        strokeLinecap="round"
                        ...
                        viewBox="0 0 24 24"
                      >
                        <path d={getProjectIconPath(project.title)} />
                      </svg>
                    </div>
                  )}
                </div>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-16 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-blue-600 via-purple-600 to-blue-600 text-white relative z-10 animate-gradient overflow-hidden">
